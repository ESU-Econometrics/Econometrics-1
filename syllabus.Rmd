...
- Office Hours: On Zoom, Fridays @ 3 pm (drop in) or ask scheduled
...
- **On Your Own**: Self-paced, reading and module-based learning. You will complete modules by submitting assignments. Some tutorials will be made available. Discussion board participation is required *before* the live conference.
- **Live Conferences**: I will be hosting two *(2)* 1-2 hour live conferences every week. This time may be used for elaboration, tutoring, questions, and discussion. You will need to submit discussion content 12 hours before the Live Conference.
...
# Prerequisites
A background in economics, probability & statistics, and calculus is expected.
...
- "Mastering 'Metrics" by Joshua D. Angrist and J&ouml;rn-Steffen Pischke
	ISBN 978-0691152844
- "Introduction to Econometrics" by Stock and Watson [Amazon](https://www.amazon.com/Introduction-Econometrics-Pearson-Economics-James-ebook/dp/B00XIGZW9W)
